    ...
    return (
        <div  style={{ background: "#fff", minHeight: "100vh", color: "#111" }}>
                ...
                <div style={{
                    ...
                    <div style={{ width: "100%", marginBottom: "-14% "}}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <h2 style={{ margin: 0, fontWeight: 600, fontSize: 22 }}>Pedra da Turmalina <span style={{ fontSize: 18 }}>
                        ...
                        <div style={{ fontSize: 15, color: "#555", marginBottom: 6 }}>BREJO DO CRUZ-PB</div>
                        <div style={{ marginTop: 8 }}>
                            ...
                            <span style={{ marginRight: 12, fontSize: 20, color: "#222" }}><i class="bi bi-linkedin"></i></span>
                            <span style={{ fontSize: 20, color: "#222" }}><i class="bi bi-browser-chrome"></i></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style={{ padding: "0 30px" }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: "20px 0 8px 0" }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                            ...
                            <img src="/images/Followus.png" alt="Crest" style={{ height: 38 }} /></span>
                        </div>
                    </div>
                    <div style={{ fontSize: 15, lineHeight: 1.6, marginBottom: 10 }}>
                        Diário Oficial do Estado (DOE),trouxe a lei sancionada pelo governador João Azevêdo (PSB) que torna a <b>'Pedra da Turmalina'</b>, símbolo do município de Brejo do Cruz, Sertão paraibano, patrimônio histórico cultural da Paraíba. A pedra é famosa por ser inspiração em uma das músicas mais conhecidas do brejo-cruzense Zé Ramalho, intitulada 'Avôhai'. O local também passa a ser considerado pela lei 12.580 como patrimônio turístico imaterial do estado.
                    </div>
                    <div style={{ display: 'flex', gap: 40, fontSize: 13, marginBottom: 10, marginTop: 18, flexWrap: 'wrap' }}>
                        <div>
                            <div style={{ fontWeight: 600, letterSpacing: 0.2 }}>Capacity</div>
                            <div>10.000 PESSOAS</div>
                        </div>
                        <div>
                            <div style={{ fontWeight: 600, letterSpacing: 0.2 }}>Opening time</div>
                            <div>14 Hours</div>
                        </div>
                        <div>
                            <div style={{ fontWeight: 600, letterSpacing: 0.2 }}>Operating days</div>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ marginTop: 0, fontSize: 15 }}>
                        <div>pedraturmalina@gmail.com</div>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 18, marginBottom: 10 }}>
                        <img src="/images/photos1.png" alt="Gallery 1" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="/images/photos2.png"alt="Gallery 2" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="/images/photos3.png" alt="Gallery 3" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="/images/photos4.png"alt="Gallery 4" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="/images/photos5.png"alt="Gallery 5" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                    </div>
                </div>
            </section>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 18, marginBottom: 10 }}>
                        ...
                        <div style={{ position: "relative" }}>
                            <iframe width="120" height="120" src="https://www.youtube.com/embed/your-video-id2" title="YouTube video" frameBorder="0" allowFullScreen style={{ borderRadius: 10 }}></iframe>
                            <img src="https://i.imgur.com/7yQ4Q4Q.png" alt="Play" style={{
                                position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 40, opacity: 0.8
                            }} />
                        </div>
                        <div style={{ position: "relative" }}>
                            <iframe width="120" height="120" src="https://www.youtube.com/embed/your-video-id3" title="YouTube video" frameBorder="0" allowFullScreen style={{ borderRadius: 10 }}></iframe>
                            <img src="https://i.imgur.com/7yQ4Q4Q.png" alt="Play" style={{
                                position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 40, opacity: 0.8
                            }} />
                        </div>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    <h4 style={{ margin: "20px 0 8px 0", fontWeight: "bold", fontSize: 16, letterSpacing: 0.2 }}>DOWNLOADABLE FILES</h4>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                        <i className="bi bi-file-earmark-arrow-down" style={{ color: '#b44aff', fontSize: 18 }}></i>
                        <a href="/downloads/logomarca.png" download style={{ color: '#b44aff', fontWeight: 600, textDecoration: 'underline', fontSize: 15 }}>LOGOMARCA</a>
                    </div>
