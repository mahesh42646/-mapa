        ...
        <div  style={{ background: "#fff", minHeight: "100vh", color: "#111" }}>
                ...
                <div style={{
                    ...
                    <div style={{ width: "100%", marginBottom: "-14% "}}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            <h2 style={{ margin: 0, fontWeight: 600, fontSize: 22 }}>Rushikesh Darkunde <span style={{ fontSize: 18 }}>
                        ...
                        <div style={{ fontSize: 15, color: "#555", marginBottom: 6 }}>TIPO: INDIVIDUAL</div>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    <h4 style={{ margin: "20px 0 8px 0", fontWeight: "bold", fontSize: 16 }}>About</h4>
                    <div style={{ fontSize: 15, lineHeight: 1.6, marginBottom: 10 }}>
                        Artista Multifacetado Que Tem Se Destacado No Cenário Musical Brasileiro. Com Sua Habilidade Impressionante Em Diversos Instrumentos E Sua Paixão Pela Música, Ele Tem Conquistado O Público E Deixado Sua Marca Em Diferentes Vertentes Da Música.<br />
                        Como Cantor, <b>Kauê</b> É Reconhecido Por Sua Voz Envolvente E Carisma No Palco, Conquistando Os Corações De Quem O Ouve. Sua Interpretação Única Traz Uma Emoção Genuína, Seja Em Canções Intimistas Ou Em Grandes Apresentações De Palco.
                    </div>
                </div>
            </section>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ marginTop: 0, fontSize: 15 }}>
                        <div>acaveadooficial@gmail.com</div>
                        <div>+83 99932-7713</div>
                    </div>
                </div>
            </section>
            ...
            <section style={{
                ...
                <div style={{ padding: "0 30px" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 18, marginBottom: 10 }}>
                        <img src="images/photo1.png" alt="Gallery 1" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="images/photo2.png"alt="Gallery 2" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="images/photo3.png" alt="Gallery 3" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="images/photo4.png"alt="Gallery 4" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                        <img src="images/photo5.png"alt="Gallery 5" style={{ width: 120, height: 120, borderRadius: 10, objectFit: "cover" }} />
                    </div>
                </div>
            </section>
            ...
            <section style={{
                ...
                <div style={{ textAlign: "left", margin: "20px 0 30px 30px", fontSize: 14 }}>
                    Here is the profile of a Cultural Agent, this page can be accessed by anyone who has the link.<br />
                    Example of public URL: <a href="https://mapadecultura.com/brejodocruz-pb/agentesculturais/55" style={{ color: "#4af", textDecoration: "underline" }}>
                        mapadecultura.com/brejodocruz-pb/agentesculturais/55
                    </a>
                </div>
